...
public class ClassificationTests
{
    ...
    [TestCase(-1)]
    [TestCase(-2)]
    public void GivenAgeIsNegative_AvailableClassifications_ThrowsAnArgumentOutOfRangeException(int age)
    {
    ...
    [TestCase(123)]
    [TestCase(124)]
    public void GivenAgeIsGreaterThan122_AvailableClassification_ThrowsAnArgumentOutOfRangeException(int age)
    {
        Assert.That(() => Program.AvailableClassifications(age), Throws.TypeOf<ArgumentOutOfRangeException>().
            With.Message.Contain(" is an invalid age."));
    }
